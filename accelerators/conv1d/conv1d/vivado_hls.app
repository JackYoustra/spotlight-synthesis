<project xmlns="com.autoesl.autopilot.project" name="conv1d" top="conv_2d">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        <file name="../systolic_test.cpp" sc="0" tb="1" cflags=" -std=c++0x -DSIGNAL_SIZE=64 -DFILTER_SIZE=16 -DCHANNEL_IN_COUNT=1 -DCHANNEL_OUT_COUNT=1 -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        <file name="conv1d/systolic.h" sc="0" tb="false" cflags="-std=c++0x -DSIGNAL_SIZE=64 -DFILTER_SIZE=16 -DCHANNEL_IN_COUNT=1 -DCHANNEL_OUT_COUNT=1" csimflags="" blackbox="false"/>
        <file name="conv1d/systolic.cpp" sc="0" tb="false" cflags="-std=c++0x -DSIGNAL_SIZE=64 -DFILTER_SIZE=16 -DCHANNEL_IN_COUNT=1 -DCHANNEL_OUT_COUNT=1" csimflags="" blackbox="false"/>
        <file name="conv1d/systolic_test.cpp" sc="0" tb="1" cflags=" -std=c++0x -DSIGNAL_SIZE=4 -DFILTER_SIZE=2 -DCHANNEL_IN_COUNT=1 -DCHANNEL_OUT_COUNT=1 -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
    </files>
    <solutions xmlns="">
        <solution name="solution1" status="active"/>
        <solution name="solution_s2_f1" status=""/>
        <solution name="solution_s4_f1" status=""/>
        <solution name="solution_s2_f2" status=""/>
        <solution name="solution_s8_f1" status=""/>
        <solution name="solution_s8_f4" status=""/>
        <solution name="solution_s4_f2" status=""/>
        <solution name="solution_s8_f6" status=""/>
        <solution name="solution_s8_f2" status=""/>
        <solution name="solution_s8_f8" status=""/>
        <solution name="solution_s16_f1" status=""/>
        <solution name="solution_s16_f2" status=""/>
        <solution name="solution_s16_f4" status=""/>
        <solution name="solution_s16_f6" status=""/>
        <solution name="solution_s16_f8" status=""/>
        ...
        <solution name="solution_test" status=""/>
    </solutions>
</project>
